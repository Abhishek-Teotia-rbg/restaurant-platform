 ...
 * @property {Array<{title: string, links: Array<{label: string, href: string}>}>} [sections] - Footer link sections
 * @property {Array<{icon: string, href: string, label: string}>} [socialLinks] - Social media links
 * @property {string} [copyright] - Copyright text
 * @property {string} [companyName] - Company name
 * @property {string} [year] - Copyright year (defaults to current year)
 */
